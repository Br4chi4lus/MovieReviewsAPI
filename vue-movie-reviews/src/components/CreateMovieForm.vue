...
<template>
  <div>
    ...
    <form @submit.prevent="onSubmit">
      ...
      <input type="text" name="directorName" id="directorName" v-model="createMovieDto.directorFirstName" required />
      <label for="directorLastName">Title:</label>
      <input type="text" name="directorLastName" id="directorLastName" v-model="createMovieDto.directorLastName" required />
      <label for="dateOfPremiere">Date of Premiere:</label>
      <input type="date" name="dateOfPremiere" id="dateOfPremiere" v-model="createMovieDto.dateOfPremiere" />
